...
class DashboardTests(unittest.TestCase):
    def test_renders_reactive_dashboard_shell(self):
        ...
        self.assertIn('icon("edit")', html)
        self.assertIn('icon("trash")', html)
        self.assertIn('aria-label", `Edit ${row.hostname}`', html)
        self.assertIn('aria-label", `Delete ${row.hostname}`', html)
